oscar_data = [
    ...
    ['02_eve лет рабства', 2013, 7.71, 133, ['драма', 'биография', 'история'], 20.0, 178.371993],
...
sum_gross = column_sum(oscar_data, 6)
total_people = 7539
spend_money = sum_gross / total_people


print('Каждый человек в среднем потратил ${:.2f} на фильмы, получившие "Оскар".'.format(spend_money))